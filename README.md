Olá! Para utilizar a aplicação é preciso ter o Node.js e npm instalados em seu computador,assim como instalar o package da @azure/openai escrevendo : 'npm install @azure/openAi' no terminal
